...
function z(n2, u2, t5, i2, r2, o2, e3, f2, c5, s2) {
  ...
  n: if ("function" == typeof T2) try {
    if (S2 = u2.props, C3 = "prototype" in T2 && T2.prototype.render, M2 = (a3 = T2.contextType) && i2[a3.__c], $2 = a3 ? M2 ? M2.props.value : a3.__ : i2, t5.__c ? b = (h2 = u2.__c = t5.__c).__ = h2.__E : (C3 ? u2.__c = h2 = new T2(S2, $2) : (u2.__c = h2 = new x(S2, $2), h2.constructor = T2, h2.render = G), M2 && M2.sub(h2), h2.state || (h2.state = {}), h2.__n = i2, p2 = h2.__d = true, h2.__h = [], h2._sb = []), C3 && null == h2.__s && (h2.__s = h2.state), C3 && null != T2.getDerivedStateFromProps && (h2.__s == h2.state && (h2.__s = w({}, h2.__s)), w(h2.__s, T2.getDerivedStateFromProps(S2, h2.__s))), y3 = h2.props, _2 = h2.state, h2.__v = u2, p2) C3 && null == T2.getDerivedStateFromProps && null != h2.componentWillMount && h2.componentWillMount(), C3 && null != h2.componentDidMount && h2.__h.push(h2.componentDidMount);
    else {
